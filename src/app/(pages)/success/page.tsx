  ...
  return (
    <div className='h-screen'>
     ...
     <div className="h-[50%] p-10 mt-10 text-center text-black">
      ...
      <Link href="/orders" className="border shadow py-2 px-5 rounded-lg text-lg hover:shadow-lg">Siparişlerim</Link>
       
       <br />
       <br />
       <br />
      <Link href="/" className="border shadow py-2 px-5 rounded-lg text-lg hover:shadow-lg">Anasayfa</Link>
     </div>
    </div>
  )
};
